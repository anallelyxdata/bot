...
namespace EchoBot1.Bots
{
    public class BugReportDialog: ComponentDialog
    {
        ...
        private async Task<DialogTurnResult> SummaryStepAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            ...
            //Obtenemos el objeto profile del user state
            var userProfile = await _stateService.UserProfileAccesor.GetAsync(stepContext.Context, () => new UserProfile(), cancellationToken);

            //Guardamos tods los datos en el user profile
